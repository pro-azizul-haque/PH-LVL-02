...
// const totalCost = products.reduce((acc, ele) => {
//    return acc + ele.price * ele.stock
// }, 0);
// console.log({ totalCost });


const highestStockProduct = products.reduce((state,ele)=>{
if(state.stock < ele.stock) return ele;
return state
},products[0])
